...
set PROJECT_ROOT= C:\_projects\mc_foc_sl_fip_dspic33ck_mclv48v300w_Melody.X
...
set HEXFILE=/dist/default/production/mc_foc_sl_fip_dspic33ck_mclv48v300w_Melody.X.production.hex
